...
pub async fn get_diff_summary(diff: &str) -> Result<String> {
    ...
    let message = format!("
        ...
        Your responsibility is to communicate the changes in this diff to the team.
        The team is non-tech, and you need to make it easy for them to understand.
        Rather than describing the diff literally, you need to summarize it.
        ...
        If there are any feature flags, mention which environments they are enabled in and disabled in.
        ----
        Diff: {diff}
    ");
